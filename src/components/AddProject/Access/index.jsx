...
const Access = ({setAccess, setPermission}) => {
    return(
        <div className="access">
            <div className="access_inner">
                <span className='access_close' onClick={() => setAccess(false)}>&#9587;</span>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <img src={people1} alt="" onClick={() => {setAccess(false); setPermission(true)}} />
                                </td>
                                <td>
